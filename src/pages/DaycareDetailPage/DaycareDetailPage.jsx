...
<div className="childcare__container">
        <div className="childcare__wrapper">
<div className="childcare__left-container">
           <p className="childcare__name">{daycareData.childcare_name}</p>
           <p className="childcare__address">{daycareData.address}, {daycareData.city},{daycareData.region}</p>
           <p className="childcare__country">{daycareData.country}</p>
           <p className="childcare__postalcode">{daycareData.postalcode}</p>
          <p className="childcare__contact-email"> {daycareData.contact_email}</p>
          <div className="childcare__contact-phone" >{daycareData.contact_phone}</div>
          <div>{<ReviewList rating = {meanRating}/>}</div>
           ...
           <p className="childcare__contact-phone"  id="daycareName">{daycareData.owner_name}</p>
           </div>
           <div className="childcare__label-container">
           <label className="childcare__label">Years</label>
                            <p className="childcare__contact-email">{daycareData.years}</p></div>
                            <div className="childcare__label-container">
                            <label className="childcare__label">Age Range</label>
                            <p className="childcare__agerange"> {daycareData.age_range}</p></div>
                            <div className="childcare__label-container">
                            <label className="childcare__label">Infant Capacity</label>
                            <p>{daycareData.infant_capacity}</p></div>
                            <div className="childcare__label-container">
                            <label className="childcare__label">Toddler Capacity</label>
                            <p>{daycareData.toddler_capacity}</p></div>
                            <div className="childcare__label-container">
                            <label className="childcare__label">Toddler Capacity</label>
                            <p>{daycareData.preschool_capacity}</p></div>
